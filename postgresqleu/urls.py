...
urlpatterns.extend([
    ...
    url(r'^events/admin/meta/speakers/(\d+)/merge/$', postgresqleu.confreg.backendviews.merge_speakers),
    url(r'^events/admin/meta/speakers/(.*/)?$', postgresqleu.confreg.backendviews.edit_global_speakers),
    ...
    url(r'^events/admin/(\w+)/regdashboard/list/multiresendwelcome/$', postgresqleu.confreg.views.admin_registration_multiresendwelcome),
    url(r'^events/admin/(\w+)/regdashboard/list/multiviewbadge/$', postgresqleu.confreg.backendviews.view_multi_registration_badge),
    ...
    url(r'^events/admin/(\w+)/regdashboard/list/(\d+)/resendattach/$', postgresqleu.confreg.views.admin_registration_resendattach),
    ...
    url(r'^events/admin/(\w+)/prepaidorders/(\d+)/refund/$', postgresqleu.confreg.backendviews.prepaidorder_refund),
    ...
    url(r'^admin/invoices/refundexposure/$', postgresqleu.invoices.backendviews.refundexposure),
