...
urlpatterns = patterns('',
	...
	(r'^events/callforpapers/(\w+)/(\d+|new)/$', postgresqleu.confreg.views.callforpapers_edit),
	(r'^events/callforpapers/(\w+)/(\d+)/delslides/(\d+)/$', 'postgresqleu.confreg.views.callforpapers_delslides'),
	...
	(r'^events/register/(\w+)/invoice/(\d+)/cancel/$', postgresqleu.confreg.views.invoice_cancel),
