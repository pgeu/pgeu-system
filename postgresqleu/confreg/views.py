...
def talkvote(request, confname):
	...
	def getusernames(all):
		firstid = all[0][0]
		for id, title, status, abstract, submissionnote, speakers, username, vote, comment, avgvote in all:
			if id != firstid:
				return
			yield username
