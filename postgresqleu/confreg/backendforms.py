...
class BackendConferenceForm(BackendForm):
    ...
    class Meta:
        model = Conference
        fields = ['active', 'callforpapersopen', 'showvotes', 'callforsponsorsopen', 'feedbackopen', 'checkinactive',
    ...
    fieldsets = [
        ...
        {'id': 'steps', 'legend': 'Steps', 'fields': ['active', 'allowedit', 'callforpapersopen', 'showvotes', 'callforsponsorsopen', 'scheduleactive', 'sessionsactive', 'cardsactive', 'checkinactive', 'conferencefeedbackopen', 'feedbackopen']},
