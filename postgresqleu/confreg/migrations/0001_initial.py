    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(default=0, choices=[(0, b'Submitted'), (1, b'Approved'), (2, b'Not Accepted'), (3, b'Pending'), (4, b'Reserve')])),
                ('lastnotifiedstatus', models.IntegerField(default=0, choices=[(0, b'Submitted'), (1, b'Approved'), (2, b'Not Accepted'), (3, b'Pending'), (4, b'Reserve')])),
