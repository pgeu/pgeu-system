    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(default=0, choices=[(0, 'Submitted'), (1, 'Approved'), (2, 'Not Accepted'), (3, 'Pending'), (4, 'Reserve')])),
                ('lastnotifiedstatus', models.IntegerField(default=0, choices=[(0, 'Submitted'), (1, 'Approved'), (2, 'Not Accepted'), (3, 'Pending'), (4, 'Reserve')])),
