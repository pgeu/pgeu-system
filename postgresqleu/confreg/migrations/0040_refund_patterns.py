    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Percent to refund')),
