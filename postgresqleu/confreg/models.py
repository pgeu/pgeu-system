...
class Speaker(models.Model):
    ...
    photo_hashval = models.BinaryField(blank=True, null=True)
    ...
    photo512_hashval = models.BinaryField(blank=True, null=True)
    lastmodified = models.DateTimeField(auto_now=True, null=False, blank=False)
...
class ConferenceSession(models.Model):
    ...
    recordingconsent = models.BooleanField(null=False, blank=False, default=True, verbose_name="Consent to recording")
