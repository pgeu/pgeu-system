...
urlpatterns = patterns('',
   ...
   (r'^(\d+)/purchase/voucher/$', views.sponsor_purchase_voucher),
   (r'^(\d+)/purchase/discountcode/$', views.sponsor_purchase_discount),
   ...
   (r'^admin/(\w+)/(\d+)/confirm/$', views.sponsor_admin_confirm),
